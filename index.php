				...
				<div class="item active" style="background-image: url(img/carousel/curso_empilhadeira_cairu.jpeg);">
					<div class="carousel-caption" style="filter: blur(0px);">
						...
						style="color: white;">Vamos<span>
								JN</span>!</h2>
						<h3 data-wow-duration="1000ms" class="wow slideInLeft animated"><span class="color">/segurança</span> é a unica definição.</h3>
						<p data-wow-duration="1000ms" class="wow slideInRight animated"><strong>Temos uma equipe capacitada</strong></p>
			...
			<div class="row mb50">
				...
				<div class="col-lg-3 col-md-3 col-sm-4 col-xs-12 wow fadeInLeft animated" data-wow-duration="500ms">
					<div class="contact-address">
						...
						<p><strong>Whatsapp:</strong> (69) 98400-8182</p>
					</div>
				</div>
				<!-- end contact address -->
