...
<!-- Page Title -->
<title>JN - Segurança e Saúde no Trabalho</title>
...
<body id="body">
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="sec-title text-center wow fadeInUp animated" data-wow-duration="700ms">
					...
					<div class="devider"><i class="fa-solid fa-heart fa-lg"></i></div>
				</div>

				<div class="sec-sub-title text-center wow fadeInRight animated" data-wow-duration="500ms">
					<p>Competência, eficiência, qualidade e garantia em tudo que faz. É por isso
						que a JN investe na qualificação permanente de seus colaboradores, contando
						com uma equipe multidisciplinar, formada por profissionais devidamente
						capacitados e aptos a prestar consultoria em segurança e saúde ocupacional
						para os mais variados segmentos e atividades econômicas.</p>
				</div>
			...
			<div class="container">
				<div class="row number-counters">
					...
					<div class="col-md-3 col-sm-6 col-xs-12 text-center wow fadeInUp animated" data-wow-duration="500ms" data-wow-delay="300ms">
						<div class="counters-item">
							<i class="fa fa-file-medical-alt fa-3x"></i>
							<strong data-to="550">0</strong>
							<!-- Set Your Number here. i,e. data-to="56" -->
							<p>Exames Realizados em Janeiro</p>
						</div>
					</div>
	...
	<section id="contact" class="contact">
		<div class="container">
			<div class="row mb50">
				...
				<div class="sec-title text-center mb50 wow fadeInDown animated" data-wow-duration="500ms">
					...
					<div class="devider"><i class="fa-solid fa-comment fa-lg"></i></div>
				</div>

				<div class="sec-sub-title text-center wow rubberBand animated" data-wow-duration="1000ms">
					<p>Mande-nos a sua dúvida ou mensagem e entraremos em contato assim que possível para resolver o seu problema.</p>
				</div>
				...
				<div class="col-lg-3 col-md-3 col-sm-4 col-xs-12 wow fadeInLeft animated" data-wow-duration="500ms">
					<div class="contact-address">
						...
						<p>Av. Presidente Dutra Nº 463, Sala 05,</p>
						<p>Dos Pioneiros, Pimenta Bueno, RO</p>
						<p><strong>Telefone:</strong> (69) 3451-8182</p>
					</div>
				</div>
				<!-- end contact address -->
		...
		<!-- Google map -->
		<iframe class="wow bounceInDown animated" data-wow-duration="500ms" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3907.265038945092!2d-61.188250586188914!3d-11.675619391715196!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x93b7e5d4c798b0fb%3A0x290eb1dfbfc11a9c!2sJN%20-%20Seguran%C3%A7a%20e%20Saude%20no%20Trabalho!5e0!3m2!1spt-BR!2sbr!4v1643574869315!5m2!1spt-BR!2sbr" width=100% height="200" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
		<!-- End Google map -->
